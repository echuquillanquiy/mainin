...
<html lang="en">
  <head>
    ...
    <meta name="description" content="mainin, construcción, mineria, mantenimiento industrial">
    <meta name="keywords" content="mainin, construcción, mineria, mantenimiento industrial">
  ...
  <body id="home">
          ...
          <div class="row">
            <div class="col-sm-8">
              <div class="nav-utility">
                <h5 class=""><a href="{{ route('login') }}"><i class="fa fa-play-circle-o"></i> INGRESAR AL SISTEMA</a></h5>
              </div><!-- .nav-utility -->
            </div><!-- .col-sm-8 -->
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="site-branding">
                  <h1 class="site-title title-image"><a href="#home" rel="home"><img src="{{ asset('web/assets/img/logo.png') }}" alt="construction business" class="img-responsive"></a></h1>
                </div><!-- .site-branding -->
              </div><!-- .col-sm-3 -->
    ...
    <div id="contact" class="contact image-block">
      <div class="container-fluid container-no-padding">
        <div class="row row-no-margin">
          <div class="image-block-item col-md-6 col-sm-5 col-xs-12">
            <div class="image-block-item-background image-block-item-map" data-lat="-12.115712" data-lng="-77.0974756"></div>
          </div><!-- .image-block-item -->
        </div><!-- .row -->
      </div><!-- .container-fluid -->
      <div class="container clear">
